...
function Menuf6Brasserie()
    ...
    local Brasserief6sub = RageUI.CreateSubMenu(Brasserief6, "Brasserie", "Interactions")
    Brasserief6:SetRectangleBanner(0, 150, 0)
    Brasserief6sub:SetRectangleBanner(0, 150, 0)
    ...
    while Brasserief6 do
        Citizen.Wait(0)
            RageUI.IsVisible(Brasserief6, true, true, true, function()
                ...
                RageUI.IsVisible(Brasserief6sub, true, true, true, function()
                ...
                if not RageUI.Visible(Brasserief6) and not RageUI.Visible(Brasserief6sub) then
